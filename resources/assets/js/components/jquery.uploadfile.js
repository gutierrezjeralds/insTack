            ...
            if($.fn.ajaxForm) {
                ...
                $(obj).append(obj.errorLog);
   				...
   				if(s.showQueueDiv)
		            ...
		            obj.container = $("<ul class='ajax-file-upload-container list-inline text-center'></ul>").insertAfter($(obj));
	...
	this.enqueueFile = function(file){
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for(var i = 0; i < files.length; i++) {
				...
				pd.filename.html(fileNameStr);
                pd.inputFileName.val(files[i].name);
        ...
        function createCustomInputFile (obj, group, s, uploadLabel) {
            ...
            var fileUploadId = "ajax-upload-id-" + s.fileName;
		...
		function defaultProgressBar(obj,s)
		{
			...
			this.statusbar = $("<li class='ajax-file-upload-statusbar list-inline-item list-inline-item-post list-upload-file'></li>").width(s.statusBarWidth);
            ...
            this.inputFileName = $("<input type='hidden' name='"+s.inputFileName+"'>").appendTo(this.statusbar).hide();
            ...
            this.inputFileName.addClass("ajax-input-file-name");
